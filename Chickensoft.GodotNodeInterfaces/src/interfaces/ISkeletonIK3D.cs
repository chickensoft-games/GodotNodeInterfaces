...
public interface ISkeletonIK3D {
    ...
    /// <summary>
    /// <para>Returns <c>true</c> if SkeletonIK is applying IK effects on continues frames to the <see cref="Skeleton3D" /> bones. Returns <c>false</c> if SkeletonIK is stopped or <see cref="M:Godot.SkeletonIK3D.Start(System.Boolean)" /> was used with the <c>one_time</c> parameter set to <c>true</c>.</para>
    /// </summary>
    bool IsRunning();
    /// <summary>

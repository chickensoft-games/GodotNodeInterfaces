...
/// <para><b>Note:</b> While GraphNode is set up using slots and slot indices, connections are made between the ports which are enabled. Because of that <see cref="GraphEdit" /> uses the port's index and not the slot's index. You can use <see cref="M:Godot.GraphNode.GetInputPortSlot(System.Int32)" /> and <see cref="M:Godot.GraphNode.GetOutputPortSlot(System.Int32)" /> to get the slot index from the port index.</para>
/// </summary>

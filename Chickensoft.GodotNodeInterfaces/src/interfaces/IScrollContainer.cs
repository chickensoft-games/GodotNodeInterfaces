...
public interface IScrollContainer : IContainer {
    ...
    /// <para><b>Note:</b> If you are setting this value in the <see cref="M:Godot.Node._Ready" /> function or earlier, it needs to be wrapped with <see cref="M:Godot.GodotObject.SetDeferred(Godot.StringName,Godot.Variant)" />, since scroll bar's <see cref="Range.MaxValue" /> is not initialized yet.</para>
    /// <para><code>
    /// func _ready():

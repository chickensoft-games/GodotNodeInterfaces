...
internal partial class ReflectionProbeNode : ReflectionProbe, IReflectionProbe { }
...
/// </summary>
public interface IReflectionProbe : IVisualInstance3D {
    /// <summary>
    ...
    /// </summary>
    float AmbientColorEnergy { get; set; }
    /// <summary>
    ...
    /// </summary>
    ReflectionProbe.AmbientModeEnum AmbientMode { get; set; }
    /// <summary>
    ...
    /// </summary>
    ReflectionProbe.UpdateModeEnum UpdateMode { get; set; }

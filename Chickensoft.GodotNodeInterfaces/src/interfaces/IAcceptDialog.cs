...
/// <summary>
/// <para>The default use of <see cref="AcceptDialog" /> is to allow it to only be accepted or closed, with the same result. However, the <see cref="AcceptDialog.Confirmed" /> and <see cref="AcceptDialog.Canceled" /> signals allow to make the two actions different, and the <see cref="M:Godot.AcceptDialog.AddButton(System.String,System.Boolean,System.String)" /> method allows to add custom buttons and actions.</para>
/// </summary>
public interface IAcceptDialog : IWindow {
    ...
    /// <summary>
    /// <para>Removes the <paramref name="button" /> from the dialog. Does NOT free the <paramref name="button" />. The <paramref name="button" /> must be a <see cref="Button" /> added with <see cref="M:Godot.AcceptDialog.AddButton(System.String,System.Boolean,System.String)" /> or <see cref="M:Godot.AcceptDialog.AddCancelButton(System.String)" /> method. After removal, pressing the <paramref name="button" /> will no longer emit this dialog's <see cref="AcceptDialog.CustomAction" /> or <see cref="AcceptDialog.Canceled" /> signals.</para>
    /// </summary>

...
/// <para><b>Note:</b> If you want to implement drag and drop for the underlying <see cref="LineEdit" />, you can use <see cref="M:Godot.Control.SetDragForwarding(Godot.Callable,Godot.Callable,Godot.Callable)" /> on the node returned by <see cref="SpinBox.GetLineEdit" />.</para>
/// </summary>

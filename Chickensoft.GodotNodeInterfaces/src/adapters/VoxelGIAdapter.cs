...
public class VoxelGIAdapter : VoxelGI, IVoxelGI {
  ...
  public VoxelGIAdapter(VoxelGI node) => _node = node;
    ...
    /// <para><b>Note:</b> <see cref="GeometryInstance3D" />s and <see cref="Light3D" />s must be fully ready before <see cref="VoxelGI.Bake(Godot.Node,System.Boolean)" /> is called. If you are procedurally creating those and some meshes or lights are missing from your baked <see cref="VoxelGI" />, use <c>call_deferred("bake")</c> instead of calling <see cref="VoxelGI.Bake(Godot.Node,System.Boolean)" /> directly.</para>
    /// </summary>
    public void Bake(Node fromNode, bool createVisualDebug) => _node.Bake(fromNode, createVisualDebug);
    /// <summary>
    ...
    /// </summary>
    public VoxelGIData Data { get => _node.Data; set => _node.Data = value; }
    /// <summary>
    /// <para>Calls <see cref="VoxelGI.Bake(Godot.Node,System.Boolean)" /> with <c>create_visual_debug</c> enabled.</para>
    /// </summary>
    public void DebugBake() => _node.DebugBake();
    /// <summary>
    ...
    /// </summary>
    public VoxelGI.SubdivEnum Subdiv { get => _node.Subdiv; set => _node.Subdiv = value; }

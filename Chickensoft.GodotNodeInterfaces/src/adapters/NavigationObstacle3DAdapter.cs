...
/// </summary>
public class NavigationObstacle3DAdapter : NavigationObstacle3D, INavigationObstacle3D {
  private readonly NavigationObstacle3D _node;

  public NavigationObstacle3DAdapter(NavigationObstacle3D node) => _node = node;
    /// <summary>

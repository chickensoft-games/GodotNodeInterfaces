...
/// </summary>
public class GpuParticlesAttractorSphere3DAdapter : GpuParticlesAttractorSphere3D, IGpuParticlesAttractorSphere3D {
  private readonly GpuParticlesAttractorSphere3D _node;

  public GpuParticlesAttractorSphere3DAdapter(GpuParticlesAttractorSphere3D node) => _node = node;
    /// <summary>

...
public class ControlAdapter : CanvasItemAdapter, IControl {
  ...
  public ControlAdapter(Control node) : base(node) { _node = node; }
    ...
    /// </code></para>
    /// </summary>
    public bool _CanDropData(Vector2 atPosition, Variant data) => _node._CanDropData(atPosition, data);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public void _DropData(Vector2 atPosition, Variant data) => _node._DropData(atPosition, data);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public Variant _GetDragData(Vector2 atPosition) => _node._GetDragData(atPosition);
    /// <summary>
    ...
    /// </summary>
    public Vector2 _GetMinimumSize() => _node._GetMinimumSize();
    /// <summary>
    ...
    /// </summary>
    public string _GetTooltip(Vector2 atPosition) => _node._GetTooltip(atPosition);
    /// <summary>
    ...
    /// </summary>
    public void _GuiInput(InputEvent @event) => _node._GuiInput(@event);
    /// <summary>
    ...
    /// </summary>
    public bool _HasPoint(Vector2 point) => _node._HasPoint(point);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public GodotObject _MakeCustomTooltip(string forText) => _node._MakeCustomTooltip(forText);
    /// <summary>
    ...
    /// </summary>
    public Godot.Collections.Array<Vector3I> _StructuredTextParser(Godot.Collections.Array args, string text) => _node._StructuredTextParser(args, text);
    /// <summary>
    ...
    /// </summary>
    public void AcceptEvent() => _node.AcceptEvent();
    /// <summary>
    ...
    /// </summary>
    public float AnchorBottom { get => _node.AnchorBottom; set => _node.AnchorBottom = value; }
    /// <summary>
    ...
    /// </summary>
    public float AnchorLeft { get => _node.AnchorLeft; set => _node.AnchorLeft = value; }
    /// <summary>
    ...
    /// </summary>
    public float AnchorRight { get => _node.AnchorRight; set => _node.AnchorRight = value; }

    public int AnchorsPreset { get => _node.AnchorsPreset; set => _node.AnchorsPreset = value; }
    /// <summary>
    ...
    /// </summary>
    public float AnchorTop { get => _node.AnchorTop; set => _node.AnchorTop = value; }
    /// <summary>
    ...
    /// </summary>
    public bool ClipContents { get => _node.ClipContents; set => _node.ClipContents = value; }
    /// <summary>
    ...
    /// </summary>
    public Vector2 CustomMinimumSize { get => _node.CustomMinimumSize; set => _node.CustomMinimumSize = value; }
    /// <summary>
    ...
    /// </summary>
    public Control FindNextValidFocus() => _node.FindNextValidFocus();
    /// <summary>
    /// <para>Finds the previous (above in the tree) <see cref="Control" /> that can receive the focus.</para>
    /// </summary>
    public Control FindPrevValidFocus() => _node.FindPrevValidFocus();
    /// <summary>
    ...
    /// </summary>
    public Control FindValidFocusNeighbor(Side side) => _node.FindValidFocusNeighbor(side);
    /// <summary>
    ...
    /// </summary>
    public Control.FocusModeEnum FocusMode { get => _node.FocusMode; set => _node.FocusMode = value; }
    /// <summary>
    ...
    /// </summary>
    public NodePath FocusNeighborBottom { get => _node.FocusNeighborBottom; set => _node.FocusNeighborBottom = value; }
    /// <summary>
    ...
    /// </summary>
    public NodePath FocusNeighborLeft { get => _node.FocusNeighborLeft; set => _node.FocusNeighborLeft = value; }
    /// <summary>
    ...
    /// </summary>
    public NodePath FocusNeighborRight { get => _node.FocusNeighborRight; set => _node.FocusNeighborRight = value; }
    /// <summary>
    ...
    /// </summary>
    public NodePath FocusNeighborTop { get => _node.FocusNeighborTop; set => _node.FocusNeighborTop = value; }
    /// <summary>
    ...
    /// </summary>
    public NodePath FocusNext { get => _node.FocusNext; set => _node.FocusNext = value; }
    /// <summary>
    ...
    /// <para>If this property is not set, Godot will select a "best guess" based on surrounding nodes in the scene tree.</para>
    /// </summary>
    public NodePath FocusPrevious { get => _node.FocusPrevious; set => _node.FocusPrevious = value; }
    /// <summary>
    ...
    public Control.CursorShape GetCursorShape(Nullable<Vector2> position) => _node.GetCursorShape(position);
    /// <summary>
    /// <para>Returns <see cref="Control.OffsetRight" /> and <see cref="Control.OffsetBottom" />.</para>
    /// </summary>
    public Vector2 GetEnd() => _node.GetEnd();
    /// <summary>
    ...
    /// </summary>
    public Rect2 GetGlobalRect() => _node.GetGlobalRect();
    /// <summary>
    /// <para>Returns the minimum size for this control. See <see cref="Control.CustomMinimumSize" />.</para>
    /// </summary>
    public Vector2 GetMinimumSize() => _node.GetMinimumSize();
    /// <summary>
    /// <para>Returns the width/height occupied in the parent control.</para>
    /// </summary>
    public Vector2 GetParentAreaSize() => _node.GetParentAreaSize();
    /// <summary>
    /// <para>Returns the parent control node.</para>
    /// </summary>
    public Control GetParentControl() => _node.GetParentControl();
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public Vector2 GetScreenPosition() => _node.GetScreenPosition();
    /// <summary>
    ...
    public string GetTooltip(Nullable<Vector2> atPosition) => _node.GetTooltip(atPosition);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public void GrabClickFocus() => _node.GrabClickFocus();
    /// <summary>
    ...
    /// </summary>
    public Control.GrowDirection GrowHorizontal { get => _node.GrowHorizontal; set => _node.GrowHorizontal = value; }
    /// <summary>
    ...
    /// </summary>
    public Control.GrowDirection GrowVertical { get => _node.GrowVertical; set => _node.GrowVertical = value; }
    /// <summary>
    ...
    /// </summary>
    public bool IsDragSuccessful() => _node.IsDragSuccessful();
    /// <summary>
    ...
    /// </summary>
    public Control.LayoutDirectionEnum LayoutDirection { get => _node.LayoutDirection; set => _node.LayoutDirection = value; }

    public int LayoutMode { get => _node.LayoutMode; set => _node.LayoutMode = value; }
    /// <summary>
    ...
    /// </summary>
    public bool LocalizeNumeralSystem { get => _node.LocalizeNumeralSystem; set => _node.LocalizeNumeralSystem = value; }
    /// <summary>
    ...
    /// </summary>
    public Control.CursorShape MouseDefaultCursorShape { get => _node.MouseDefaultCursorShape; set => _node.MouseDefaultCursorShape = value; }
    /// <summary>
    ...
    /// </summary>
    public Control.MouseFilterEnum MouseFilter { get => _node.MouseFilter; set => _node.MouseFilter = value; }
    /// <summary>
    ...
    /// </summary>
    public bool MouseForcePassScrollEvents { get => _node.MouseForcePassScrollEvents; set => _node.MouseForcePassScrollEvents = value; }
    /// <summary>
    ...
    /// </summary>
    public Vector2 PivotOffset { get => _node.PivotOffset; set => _node.PivotOffset = value; }
    /// <summary>
    ...
    /// </summary>
    public void ReleaseFocus() => _node.ReleaseFocus();
    /// <summary>
    ...
    /// </summary>
    public void SetAnchor(Side side, float anchor, bool keepOffset, bool pushOppositeAnchor) => _node.SetAnchor(side, anchor, keepOffset, pushOppositeAnchor);
    /// <summary>
    ...
    /// </summary>
    public void SetAnchorAndOffset(Side side, float anchor, float offset, bool pushOppositeAnchor) => _node.SetAnchorAndOffset(side, anchor, offset, pushOppositeAnchor);
    /// <summary>
    ...
    /// </summary>
    public void SetAnchorsAndOffsetsPreset(Control.LayoutPreset preset, Control.LayoutPresetMode resizeMode, int margin) => _node.SetAnchorsAndOffsetsPreset(preset, resizeMode, margin);
    /// <summary>
    ...
    /// </summary>
    public void SetAnchorsPreset(Control.LayoutPreset preset, bool keepOffsets) => _node.SetAnchorsPreset(preset, keepOffsets);
    /// <summary>
    ...
    /// </summary>
    public void SetBegin(Vector2 position) => _node.SetBegin(position);
    /// <summary>
    ...
    /// </summary>
    public void SetDragForwarding(Callable dragFunc, Callable canDropFunc, Callable dropFunc) => _node.SetDragForwarding(dragFunc, canDropFunc, dropFunc);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public void SetDragPreview(Control control) => _node.SetDragPreview(control);
    /// <summary>
    /// <para>Sets <see cref="Control.OffsetRight" /> and <see cref="Control.OffsetBottom" /> at the same time.</para>
    /// </summary>
    public void SetEnd(Vector2 position) => _node.SetEnd(position);
    /// <summary>
    ...
    /// </summary>
    public void SetGlobalPosition(Vector2 position, bool keepOffsets) => _node.SetGlobalPosition(position, keepOffsets);
    /// <summary>
    ...
    /// </summary>
    public void SetOffsetsPreset(Control.LayoutPreset preset, Control.LayoutPresetMode resizeMode, int margin) => _node.SetOffsetsPreset(preset, resizeMode, margin);
    /// <summary>
    /// <para>Sets the <see cref="Control.Position" /> to given <paramref name="position" />.</para>
    /// <para>If <paramref name="keepOffsets" /> is <c>true</c>, control's anchors will be updated instead of offsets.</para>
    /// </summary>
    public void SetPosition(Vector2 position, bool keepOffsets) => _node.SetPosition(position, keepOffsets);
    /// <summary>
    /// <para>Sets the size (see <see cref="Control.Size" />).</para>
    /// <para>If <paramref name="keepOffsets" /> is <c>true</c>, control's anchors will be updated instead of offsets.</para>
    /// </summary>
    public void SetSize(Vector2 size, bool keepOffsets) => _node.SetSize(size, keepOffsets);
    /// <summary>
    ...
    /// </summary>
    public Node ShortcutContext { get => _node.ShortcutContext; set => _node.ShortcutContext = value; }
    /// <summary>
    ...
    /// </summary>
    public Vector2 Size { get => _node.Size; set => _node.Size = value; }
    /// <summary>
    ...
    /// </summary>
    public Control.SizeFlags SizeFlagsHorizontal { get => _node.SizeFlagsHorizontal; set => _node.SizeFlagsHorizontal = value; }
    /// <summary>
    ...
    /// </summary>
    public float SizeFlagsStretchRatio { get => _node.SizeFlagsStretchRatio; set => _node.SizeFlagsStretchRatio = value; }
    /// <summary>
    ...
    /// </summary>
    public Control.SizeFlags SizeFlagsVertical { get => _node.SizeFlagsVertical; set => _node.SizeFlagsVertical = value; }
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public string TooltipText { get => _node.TooltipText; set => _node.TooltipText = value; }
    /// <summary>
    ...
    /// </summary>
    public void UpdateMinimumSize() => _node.UpdateMinimumSize();
    /// <summary>

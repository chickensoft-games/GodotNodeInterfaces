...
public class Area2DAdapter : CollisionObject2DAdapter, IArea2D {
  ...
  public Area2DAdapter(Node node) : base(node) {
    ...
    /// </summary>
    public Area2D.SpaceOverride AngularDampSpaceOverride { get => _node.AngularDampSpaceOverride; set => _node.AngularDampSpaceOverride = value; }
    /// <summary>
    ...
    /// </summary>
    public Godot.Collections.Array<Area2D> GetOverlappingAreas() => _node.GetOverlappingAreas();
    /// <summary>
    ...
    /// <para>For performance reasons (collisions are all processed at the same time) this list is modified once during the physics step, not immediately after objects are moved. Consider using signals instead.</para>
    /// </summary>
    public Godot.Collections.Array<Node2D> GetOverlappingBodies() => _node.GetOverlappingBodies();
    /// <summary>
    ...
    /// </summary>
    public Vector2 GravityDirection { get => _node.GravityDirection; set => _node.GravityDirection = value; }
    /// <summary>
    ...
    /// </summary>
    public Vector2 GravityPointCenter { get => _node.GravityPointCenter; set => _node.GravityPointCenter = value; }
    /// <summary>
    ...
    /// </summary>
    public Area2D.SpaceOverride GravitySpaceOverride { get => _node.GravitySpaceOverride; set => _node.GravitySpaceOverride = value; }
    /// <summary>
    ...
    /// </summary>
    public Area2D.SpaceOverride LinearDampSpaceOverride { get => _node.LinearDampSpaceOverride; set => _node.LinearDampSpaceOverride = value; }
    /// <summary>

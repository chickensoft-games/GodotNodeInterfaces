...
/// </summary>
public class NavigationAgent2DAdapter : NavigationAgent2D, INavigationAgent2D {
  private readonly NavigationAgent2D _node;

  public NavigationAgent2DAdapter(NavigationAgent2D node) => _node = node;
    /// <summary>
    ...
    /// </summary>
    public float DebugPathCustomLineWidth { get => _node.DebugPathCustomLineWidth; set => _node.DebugPathCustomLineWidth = value; }
    /// <summary>
    ...
    /// </summary>
    public Vector2[] GetCurrentNavigationPath() => _node.GetCurrentNavigationPath();
    /// <summary>
    ...
    /// </summary>
    public NavigationPathQueryResult2D GetCurrentNavigationResult() => _node.GetCurrentNavigationResult();
    /// <summary>
    ...
    /// </summary>
    public Vector2 GetFinalPosition() => _node.GetFinalPosition();
    /// <summary>
    ...
    /// <summary>
    /// <para>Returns the <see cref="Rid" /> of the navigation map for this NavigationAgent node. This function returns always the map set on the NavigationAgent node and not the map of the abstract agent on the NavigationServer. If the agent map is changed directly with the NavigationServer API the NavigationAgent node will not be aware of the map change. Use <see cref="NavigationAgent2D.SetNavigationMap(Godot.Rid)" /> to change the navigation map for the NavigationAgent and also update the agent on the NavigationServer.</para>
    /// </summary>
    ...
    /// </summary>
    public Vector2 GetNextPathPosition() => _node.GetNextPathPosition();
    /// <summary>
    ...
    /// </summary>
    public NavigationPathQueryParameters2D.PathfindingAlgorithmEnum PathfindingAlgorithm { get => _node.PathfindingAlgorithm; set => _node.PathfindingAlgorithm = value; }
    /// <summary>
    ...
    /// </summary>
    public NavigationPathQueryParameters2D.PathMetadataFlags PathMetadataFlags { get => _node.PathMetadataFlags; set => _node.PathMetadataFlags = value; }
    /// <summary>
    ...
    /// </summary>
    public NavigationPathQueryParameters2D.PathPostProcessing PathPostprocessing { get => _node.PathPostprocessing; set => _node.PathPostprocessing = value; }
    /// <summary>
    ...
    /// </summary>
    public void SetVelocityForced(Vector2 velocity) => _node.SetVelocityForced(velocity);
    /// <summary>

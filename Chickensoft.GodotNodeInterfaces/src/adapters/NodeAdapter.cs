...
public class NodeAdapter : INode, IAdapter {
  ...
  public NodeAdapter(Node node) { _node = node; }
    ...
    /// </summary>
    public void _EnterTree() => _node._EnterTree();
    /// <summary>
    ...
    /// </summary>
    public void _ExitTree() => _node._ExitTree();
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public string[] _GetConfigurationWarnings() => _node._GetConfigurationWarnings();

    public NodePath _ImportPath { get => _node._ImportPath; set => _node._ImportPath = value; }
    /// <summary>
    ...
    /// </summary>
    public void _Input(InputEvent @event) => _node._Input(@event);
    /// <summary>
    ...
    /// <para><b>Note:</b> This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).</para>
    /// </summary>
    public void _PhysicsProcess(double delta) => _node._PhysicsProcess(delta);
    /// <summary>
    ...
    /// <para><b>Note:</b> This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).</para>
    /// </summary>
    public void _Process(double delta) => _node._Process(delta);
    /// <summary>
    ...
    /// </summary>
    public void _Ready() => _node._Ready();
    /// <summary>
    ...
    /// </summary>
    public void _ShortcutInput(InputEvent @event) => _node._ShortcutInput(@event);
    /// <summary>
    ...
    /// <para><b>Note:</b> This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).</para>
    /// </summary>
    public void _UnhandledInput(InputEvent @event) => _node._UnhandledInput(@event);
    /// <summary>
    ...
    /// <para><b>Note:</b> This method is only called if the node is present in the scene tree (i.e. if it's not an orphan).</para>
    /// </summary>
    public void _UnhandledKeyInput(InputEvent @event) => _node._UnhandledKeyInput(@event);
    /// <summary>
    ...
    /// </summary>
    public void AddChild(Node node, bool forceReadableName, Node.InternalMode @internal) => _node.AddChild(node, forceReadableName, @internal);
    /// <summary>
    ...
    /// </summary>
    public void AddSibling(Node sibling, bool forceReadableName) => _node.AddSibling(sibling, forceReadableName);
    /// <summary>
    ...
    /// </summary>
    public void AddToGroup(StringName @group, bool persistent) => _node.AddToGroup(@group, persistent);
    /// <summary>
    ...
    /// </summary>
    public Variant CallDeferredThreadGroup(StringName @method, Variant[] args) => _node.CallDeferredThreadGroup(@method, args);
    /// <summary>
    ...
    /// </summary>
    public Variant CallThreadSafe(StringName @method, Variant[] args) => _node.CallThreadSafe(@method, args);
    /// <summary>
    ...
    /// </summary>
    public bool CanProcess() => _node.CanProcess();
    /// <summary>
    ...
    /// </summary>
    public Tween CreateTween() => _node.CreateTween();
    /// <summary>
    ...
    /// </summary>
    public Node Duplicate(int flags) => _node.Duplicate(flags);
    /// <summary>
    /// <para>Add a custom description to a node. It will be displayed in a tooltip when hovered in editor's scene tree.</para>
    /// </summary>
    public string EditorDescription { get => _node.EditorDescription; set => _node.EditorDescription = value; }
    /// <summary>
    ...
    /// </summary>
    public Node FindChild(string pattern, bool recursive, bool owned) => _node.FindChild(pattern, recursive, owned);
    /// <summary>
    ...
    /// </summary>
    public Godot.Collections.Array<Node> FindChildren(string pattern, string @type, bool recursive, bool owned) => _node.FindChildren(pattern, @type, recursive, owned);
    /// <summary>
    ...
    /// </summary>
    public Node FindParent(string pattern) => _node.FindParent(pattern);
    /// <summary>
    ...
    /// </returns>
    public T GetChild<T>(int idx, bool includeInternal) where T : class => _node.GetChild<T>(idx, includeInternal);
    /// <summary>
    ...
    /// </summary>
    public Node GetChild(int idx, bool includeInternal) => _node.GetChild(idx, includeInternal);
    /// <summary>
    ...
    /// </summary>
    public int GetChildCount(bool includeInternal) => _node.GetChildCount(includeInternal);
    /// <summary>
    /// Returns a child node by its index (see <see cref="Node.GetChildCount(System.Boolean)" />).
    /// This method is often used for iterating all children of a node.
    /// Negative indices access the children from the last one.
    ...
    /// </returns>
    public T GetChildOrNull<T>(int idx, bool includeInternal) where T : class => _node.GetChildOrNull<T>(idx, includeInternal);
    /// <summary>
    ...
    /// </summary>
    public Godot.Collections.Array<Node> GetChildren(bool includeInternal) => _node.GetChildren(includeInternal);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public Godot.Collections.Array<StringName> GetGroups() => _node.GetGroups();
    /// <summary>
    ...
    /// </summary>
    public int GetIndex(bool includeInternal) => _node.GetIndex(includeInternal);
    /// <summary>
    ...
    /// </summary>
    public Window GetLastExclusiveWindow() => _node.GetLastExclusiveWindow();
    /// <summary>
    ...
    /// </summary>
    public int GetMultiplayerAuthority() => _node.GetMultiplayerAuthority();
    /// <summary>
    ...
    /// </returns>
    public T GetNode<T>(NodePath path) where T : class => _node.GetNode<T>(path);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public Node GetNode(NodePath path) => _node.GetNode(path);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public Godot.Collections.Array GetNodeAndResource(NodePath path) => _node.GetNodeAndResource(path);
    /// <summary>
    ...
    /// </returns>
    public T GetNodeOrNull<T>(NodePath path) where T : class => _node.GetNodeOrNull<T>(path);
    /// <summary>
    ...
    /// </summary>
    public Node GetNodeOrNull(NodePath path) => _node.GetNodeOrNull(path);
    /// <summary>
    ...
    /// </returns>
    public T GetOwner<T>() where T : class => _node.GetOwner<T>();
    /// <summary>
    /// The node owner. A node can have any other node as owner (as long as it is
    /// a valid parent, grandparent, etc. ascending in the tree). When saving a
    /// node (using <see cref="PackedScene" />), all the nodes it owns will be saved
    ...
    /// </returns>
    public T GetOwnerOrNull<T>() where T : class => _node.GetOwnerOrNull<T>();
    /// <summary>
    ...
    /// </returns>
    public T GetParent<T>() where T : class => _node.GetParent<T>();
    /// <summary>
    ...
    /// </returns>
    public T GetParentOrNull<T>() where T : class => _node.GetParentOrNull<T>();
    /// <summary>
    ...
    /// </summary>
    public NodePath GetPath() => _node.GetPath();
    /// <summary>
    ...
    /// </summary>
    public NodePath GetPathTo(Node node, bool useUniquePath) => _node.GetPathTo(node, useUniquePath);
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public string GetTreeString() => _node.GetTreeString();
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public string GetTreeStringPretty() => _node.GetTreeStringPretty();
    /// <summary>
    /// <para>Returns the node's <see cref="Viewport" />.</para>
    /// </summary>
    public Viewport GetViewport() => _node.GetViewport();
    /// <summary>
    ...
    /// </summary>
    public Window GetWindow() => _node.GetWindow();
    /// <summary>
    /// <para>Returns <c>true</c> if the node that the <see cref="NodePath" /> points to exists.</para>
    /// </summary>
    public bool HasNode(NodePath path) => _node.HasNode(path);
    /// <summary>
    ...
    /// </summary>
    public bool HasNodeAndResource(NodePath path) => _node.HasNodeAndResource(path);
    /// <summary>
    /// <para>Returns <c>true</c> if the given node is a direct or indirect child of the current node.</para>
    /// </summary>
    public bool IsAncestorOf(Node node) => _node.IsAncestorOf(node);
    /// <summary>
    ...
    /// </summary>
    public bool IsDisplayedFolded() => _node.IsDisplayedFolded();
    /// <summary>
    ...
    /// </summary>
    public bool IsEditableInstance(Node node) => _node.IsEditableInstance(node);
    /// <summary>
    /// <para>Returns <c>true</c> if the given node occurs later in the scene hierarchy than the current node.</para>
    /// </summary>
    public bool IsGreaterThan(Node node) => _node.IsGreaterThan(node);
    /// <summary>
    ...
    /// </summary>
    public bool IsProcessingUnhandledInput() => _node.IsProcessingUnhandledInput();
    /// <summary>
    ...
    /// </summary>
    public bool IsProcessingUnhandledKeyInput() => _node.IsProcessingUnhandledKeyInput();
    /// <summary>
    ...
    /// </summary>
    public void MoveChild(Node childNode, int toIndex) => _node.MoveChild(childNode, toIndex);
    /// <summary>
    ...
    /// </summary>
    public MultiplayerApi Multiplayer { get => _node.Multiplayer; }
    /// <summary>
    ...
    /// </summary>
    public Node Owner { get => _node.Owner; set => _node.Owner = value; }
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public void PrintTree() => _node.PrintTree();
    /// <summary>
    ...
    /// </code></para>
    /// </summary>
    public void PrintTreePretty() => _node.PrintTreePretty();
    /// <summary>
    ...
    /// </summary>
    public Node.ProcessModeEnum ProcessMode { get => _node.ProcessMode; set => _node.ProcessMode = value; }
    /// <summary>
    ...
    /// </summary>
    public int ProcessPhysicsPriority { get => _node.ProcessPhysicsPriority; set => _node.ProcessPhysicsPriority = value; }
    /// <summary>
    ...
    /// </summary>
    public int ProcessPriority { get => _node.ProcessPriority; set => _node.ProcessPriority = value; }
    /// <summary>
    ...
    /// </summary>
    public Node.ProcessThreadGroupEnum ProcessThreadGroup { get => _node.ProcessThreadGroup; set => _node.ProcessThreadGroup = value; }
    /// <summary>
    ...
    /// </summary>
    public int ProcessThreadGroupOrder { get => _node.ProcessThreadGroupOrder; set => _node.ProcessThreadGroupOrder = value; }
    /// <summary>
    ...
    /// </summary>
    public Node.ProcessThreadMessagesEnum ProcessThreadMessages { get => _node.ProcessThreadMessages; set => _node.ProcessThreadMessages = value; }
    /// <summary>
    ...
    /// </summary>
    public void PropagateCall(StringName @method, Godot.Collections.Array args, bool parentFirst) => _node.PropagateCall(@method, args, parentFirst);
    /// <summary>
    ...
    /// </summary>
    public void PropagateNotification(int what) => _node.PropagateNotification(what);
    /// <summary>
    ...
    /// </summary>
    public void QueueFree() => _node.QueueFree();
    /// <summary>
    ...
    /// </summary>
    public void RemoveChild(Node node) => _node.RemoveChild(node);
    /// <summary>
    ...
    /// </summary>
    public void RemoveFromGroup(StringName @group) => _node.RemoveFromGroup(@group);
    /// <summary>
    ...
    /// </summary>
    public void Reparent(Node newParent, bool keepGlobalTransform) => _node.Reparent(newParent, keepGlobalTransform);
    /// <summary>
    ...
    /// </summary>
    public void ReplaceBy(Node node, bool keepGroups) => _node.ReplaceBy(node, keepGroups);
    /// <summary>
    ...
    /// </summary>
    public void RequestReady() => _node.RequestReady();
    /// <summary>
    ...
    /// </summary>
    public Error Rpc(StringName @method, Variant[] args) => _node.Rpc(@method, args);
    /// <summary>
    ...
    /// </summary>
    public void RpcConfig(StringName @method, Variant config) => _node.RpcConfig(@method, config);
    /// <summary>
    ...
    /// </summary>
    public Error RpcId(long peerId, StringName @method, Variant[] args) => _node.RpcId(peerId, @method, args);
    /// <summary>
    ...
    /// </summary>
    public string SceneFilePath { get => _node.SceneFilePath; set => _node.SceneFilePath = value; }
    /// <summary>
    /// <para>Similar to <see cref="Node.CallDeferredThreadGroup(Godot.StringName,Godot.Variant[])" />, but for setting properties.</para>
    /// </summary>
    public void SetDeferredThreadGroup(StringName @property, Variant value) => _node.SetDeferredThreadGroup(@property, value);
    /// <summary>
    /// <para>Sets the folded state of the node in the Scene dock. This method is only intended for use with editor tooling.</para>
    /// </summary>
    public void SetDisplayFolded(bool fold) => _node.SetDisplayFolded(fold);
    /// <summary>
    ...
    /// </summary>
    public void SetEditableInstance(Node node, bool isEditable) => _node.SetEditableInstance(node, isEditable);
    /// <summary>
    ...
    /// </summary>
    public void SetMultiplayerAuthority(int id, bool recursive) => _node.SetMultiplayerAuthority(id, recursive);
    /// <summary>
    ...
    /// </summary>
    public void SetPhysicsProcess(bool enable) => _node.SetPhysicsProcess(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetPhysicsProcessInternal(bool enable) => _node.SetPhysicsProcessInternal(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetProcess(bool enable) => _node.SetProcess(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetProcessInput(bool enable) => _node.SetProcessInput(enable);
    /// <summary>
    ...
    /// <para><b>Warning:</b> Built-in Nodes rely on the internal processing for their own logic, so changing this value from your code may lead to unexpected behavior. Script access to this internal logic is provided for specific advanced uses, but is unsafe and not supported.</para>
    /// </summary>
    public void SetProcessInternal(bool enable) => _node.SetProcessInternal(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetProcessShortcutInput(bool enable) => _node.SetProcessShortcutInput(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetProcessUnhandledInput(bool enable) => _node.SetProcessUnhandledInput(enable);
    /// <summary>
    ...
    /// </summary>
    public void SetProcessUnhandledKeyInput(bool enable) => _node.SetProcessUnhandledKeyInput(enable);
    /// <summary>
    /// <para>Sets whether this is an instance load placeholder. See <see cref="InstancePlaceholder" />.</para>
    /// </summary>
    public void SetSceneInstanceLoadPlaceholder(bool loadPlaceholder) => _node.SetSceneInstanceLoadPlaceholder(loadPlaceholder);
    /// <summary>
    /// <para>Similar to <see cref="Node.CallThreadSafe(Godot.StringName,Godot.Variant[])" />, but for setting properties.</para>
    /// </summary>
    public void SetThreadSafe(StringName @property, Variant value) => _node.SetThreadSafe(@property, value);
    /// <summary>
    ...
    /// </summary>
    public bool UniqueNameInOwner { get => _node.UniqueNameInOwner; set => _node.UniqueNameInOwner = value; }
    /// <summary>
    ...
    /// </summary>
    public void UpdateConfigurationWarnings() => _node.UpdateConfigurationWarnings();

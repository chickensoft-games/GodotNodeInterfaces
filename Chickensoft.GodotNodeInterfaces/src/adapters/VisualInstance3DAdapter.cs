...
public class VisualInstance3DAdapter : VisualInstance3D, IVisualInstance3D {
  ...
  public VisualInstance3DAdapter(VisualInstance3D node) => _node = node;
    ...
    /// </summary>
    public Aabb GetAabb() => _node.GetAabb();
    /// <summary>
    ...
    /// </summary>
    public Rid GetBase() => _node.GetBase();
    /// <summary>
    ...
    /// </summary>
    public Rid GetInstance() => _node.GetInstance();
    /// <summary>
    ...
    /// </summary>
    public bool GetLayerMaskValue(int layerNumber) => _node.GetLayerMaskValue(layerNumber);
    /// <summary>
    ...
    /// <para>To adjust <see cref="VisualInstance3D.Layers" /> more easily using a script, use <see cref="VisualInstance3D.GetLayerMaskValue(System.Int32)" /> and <see cref="VisualInstance3D.SetLayerMaskValue(System.Int32,System.Boolean)" />.</para>
    ...
    /// </summary>
    public uint Layers { get => _node.Layers; set => _node.Layers = value; }
    /// <summary>
    /// <para>Sets the resource that is instantiated by this <see cref="VisualInstance3D" />, which changes how the engine handles the <see cref="VisualInstance3D" /> under the hood. Equivalent to <see cref="RenderingServer.InstanceSetBase(Godot.Rid,Godot.Rid)" />.</para>
    /// </summary>
    public void SetBase(Rid @base) => _node.SetBase(@base);
    /// <summary>
    ...
    /// </summary>
    public void SetLayerMaskValue(int layerNumber, bool value) => _node.SetLayerMaskValue(layerNumber, value);
    /// <summary>
    ...
    /// </summary>
    public float SortingOffset { get => _node.SortingOffset; set => _node.SortingOffset = value; }
    /// <summary>
    ...
    /// </summary>
    public bool SortingUseAabbCenter { get => _node.SortingUseAabbCenter; set => _node.SortingUseAabbCenter = value; }
